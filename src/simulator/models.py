...
class BaseParams(models.Model):
    ...
    prob_speed_min = models.FloatField(null=True)
    prob_speed_max = models.FloatField(null=True) # initial speed delivered in [min, max]
    ...
    prob_timing_min = models.FloatField(null=True)
    prob_timing_max = models.FloatField(null=True)
